...
public class BGARefreshLayout3Activity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        bgaRl.setDelegate(new BGARefreshLayout.BGARefreshLayoutDelegate() {
            ...
            public void onBGARefreshLayoutBeginRefreshing(BGARefreshLayout refreshLayout) {
                //刷新进行的操作
                DemonstrateUtil.showToastResult(BGARefreshLayout3Activity.this,"onBGARefreshLayoutBeginRefreshing");
